...
/* =======================
   ...
   - Lazy load: pdf.js (~800KB+) chỉ được tải khi người dùng
     mở tab "thông tin" lần đầu, không tải ngay khi vào trang.
======================= */
let __pdfViewerInited = false;

function initPdfViewerOnce() {
  if (__pdfViewerInited) return;
  __pdfViewerInited = true;
  ...
  script.onload = setupPdfViewer;
  script.onerror = () => console.error("Không tải được thư viện PDF.js");
